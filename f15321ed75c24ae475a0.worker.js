  ...
  \**************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var testFunction = function testFunction(func, input, output) {
          ...
          console.log('created function wrapper', func.addNums)

          try {
            for (var i = 0; i < input.length; i++) {
              var theirResult = func.addNums.apply(
                func,
                _toConsumableArray(input[i]).concat([(addNums = func.addNums)])
              )
            ...
            result = e.toString() + ' from testFunction'
          }
  ...
  \***********************************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        self.addEventListener('message', function(event) {
          ...
          var result = (0, _testFunction.default)(
            (0, _createFunction.default)(args, body),
            input,
            output
          )
          self.postMessage(result) // self.postMessage(data)
        })
...
//# sourceMappingURL=f15321ed75c24ae475a0.worker.js.map
