      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        self.addEventListener('message', function(event) {
          ...
          var args = data.args,
            ...
            input = data.input,
            output = data.output
          console.log('received args from master in utils', args)
          console.log('received input from master in utils', input)
          console.log('received body from master in utils', body)
          console.log('received output from master in utils', output)
...
//# sourceMappingURL=c437fc55c73ed0675449.worker.js.map
